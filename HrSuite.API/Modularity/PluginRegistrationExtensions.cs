...
public static class BaseMenu
{
    public static readonly IReadOnlyList<MenuEntry> Entries = new[]
    {
        ...
        new MenuEntry("hr.jobRequisition","Job Requisitions","/hr/recruitment",    "briefcase", 70,  null, "hr.jobRequisition.view"),
        new MenuEntry("admin.fieldBuilder","Field Builder",  "/hr/field-builder",  "sliders",   810, null, "admin.customField"),
        new MenuEntry("admin.fieldColumns","Screen Fields",  "/hr/screen-fields",  "table",     820, null, "admin.fieldColumn"),
